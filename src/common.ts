...
export const LynxCardCycle: Record<string, string | undefined> = {
  ...
  onShow: "_lynxCardOnShow", // TODO 需要在 componentDidMount -> this.getJSModule("GlobalEventEmitter").addListener("onShow", this._lynxCardOnShow)
  onHide: "_lynxCardOnHide", // TODO 需要在 componentDidMount -> this.getJSModule("GlobalEventEmitter").addListener("onHide", this._lynxCardOnHide)
